...
# Configuration
M3U_URL = "https://tt2.unlimitedtvsolution.workers.dev/playlist"  # URL to download the M3U file from
LOCAL_REPO_PATH = os.getcwd()  # The current working directory (repo path)
M3U_FILENAME = "thetvapp.m3u"  # File name for the downloaded M3U file
COMMIT_MESSAGE = "Update M3U file"
